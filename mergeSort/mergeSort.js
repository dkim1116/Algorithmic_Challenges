...
//       return;
//     }
//     recursiveSort(arr.slice(1));
//   };
//   recursiveSort(newArray);
//   return newArray;
// };
...
//   var recFun = function (first, last) {
...
//         newSubset.push([input[i+1],input[i]]);
//       } else {
//         newSubset.push([input[i], input[i+1]]);
//       }
//     }
//     danger--
//     recFun(newSubset);
...
// var mergeSort = function(array) {
//   var divided = divide(array);
//   var recFun = function(input){
//     if(input[0].length === array.length) {
//       return input[0];
//     }
//     var subset = [];
//     var leftCount = 0;
//     var rightCount = 0;
//     for (var i = 0; i < input.length; i+2) {
//       if (input[i][leftCount] >= input[i][rightCount]) {
//         subset.push(input[i][rightCount]);
//         rightCount++;
//       } else {
//         subset.push(input[i][leftCount]);
//         leftCount++
//       }
//     }
//     // if (leftCount === input[0].length-1 && rightCount === input[0].length-1) {
//     //   recFun(subset);
//     // }
//   };
//   return recFun(divided);
// };


// console.log(mergeSort([4,7,4,3,9,1,2,13,11,12,10]))
...
var merge = function(left, right) {
  ...
  while(left.length && right.length) {
    if(left[0] >= right[0]){
      subset.push(right.shift());
    } else {
      subset.push(left.shift());
    }
  }
  while(left.length){
    subset.push(left.shift());
...
var fibo = function (val) {
  return val < 2 ? 1 : fibo(val-1) + fibo(val - 2)
}
