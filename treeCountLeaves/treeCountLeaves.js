...
Tree.prototype.countLeaves = function () {
  // TODO: implement me!
  // Declare a variable to keep track of the count, which should start off with a value of 0
  var leafCount = 0;
  // Declare a recursive function that will take in "this" itself when it is initially invoked
  var recursivefunction = function(input){
    // BASE CASE
    //If the input doesnt have any children, return
    ...
    //recursive call on the iterated children
  };
  // check 
  // invoke the recursivefunction with "this"
