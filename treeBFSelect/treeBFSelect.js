...
Tree.prototype.BFsearch = function (value) {
  ...
  var recFun = function (node) {
    ...
    console.log('AFTER ASSIGNMENT ', parentChildren);

    for (var j = 0; j < parentChildren[i].children.length; j++) {
      console.log('CURRENT NODE', node);

      if (parentChildren[i].children[j].length) {
        recFun(parentChildren[i].children[j]);
